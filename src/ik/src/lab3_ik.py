...
def move():
    ...
    Call using:
    $ rosrun intera_examples go_to_cartesian_pose.py -q 0.0 -0.9 0.0 1.8 0.0 -0.9 0.0 [arguments: see below]
    ...
    parser.add_argument(
        "--linear_speed", type=float, default=6.,
        help="The max linear speed of the endpoint (m/s)")
    parser.add_argument(
        "--linear_accel", type=float, default=6.,
        help="The max linear acceleration of the endpoint (m/s/s)")
    parser.add_argument(
        "--rotational_speed", type=float, default=100.57,
        help="The max rotational speed of the endpoint (rad/s)")
    parser.add_argument(
        "--rotational_accel", type=float, default=100.57,
    ...
    try:
        ...
        pose.position.x = 0.6
        pose.position.y = (latest_pose.pose.position.x)#, -0.5, 0.5)
        pose.position.z = (latest_pose.pose.position.y)#, -0.5, 0.5)
